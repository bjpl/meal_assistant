...
// Pattern validation
export const patternSelectSchema = Joi.object({
...
export const patternSwitchSchema = Joi.object({
...
// Meal validation
export const mealLogSchema = Joi.object({
...
export const mealSubstituteSchema = Joi.object({
...
export const inventoryBatchSchema = Joi.object({
  items: Joi.array()
...
export const inventoryConsumeSchema = Joi.object({
  mealId: Joi.string().uuid().required(),
...
// Prep validation
export const prepScheduleSchema = Joi.object({
  patternType: Joi.string()
    .valid(...Object.values(PatternType))
    .required(),
  date: Joi.string()
...
export const prepTaskUpdateSchema = Joi.object({
  status: Joi.string()
...
// Shopping validation
export const shoppingGenerateSchema = Joi.object({
  patterns: Joi.array()
    .items(
      Joi.object({
        patternType: Joi.string()
...
export const shoppingOptimizeSchema = Joi.object({
...
export const shoppingCheckSchema = Joi.object({
...
export const hydrationLogSchema = Joi.object({
...
export const caffeineLogSchema = Joi.object({
  beverage_type: Joi.string()
...
export const hydrationGoalsUpdateSchema = Joi.object({
...
export const hydrationTrendsQuerySchema = Joi.object({
  period: Joi.string()
...
// Upload a weekly ad
export const adUploadSchema = Joi.object({
  fileData: Joi.string()
    .required()
    .messages({
...
// Process an ad
export const adProcessSchema = Joi.object({
  useML: Joi.boolean()
    .default(false),
...
// Correct a deal
export const dealCorrectSchema = Joi.object({
...
export const dealMatchSchema = Joi.object({
...
// A/B test a template
export const templateTestSchema = Joi.object({
  adId: Joi.string()
    .uuid()
    .required()
    .messages({
...
export {
  ...
  locationSchema,
  storeSchema,
  itemSchema as optimizationItemSchema
} from './optimizationSchemas';
