 ...
 */
export const priceCaptureSchema = Joi.object({
 ...
 */
export const dealAssessSchema = Joi.object({
 ...
 */
export const salePredictSchema = Joi.object({
  componentId: Joi.string()
    .required()
    .messages({
      'any.required': 'Component ID is required'
 ...
 */
export const receiptItemCorrectSchema = Joi.object({
 ...
 */
export const priceAlertCreateSchema = Joi.object({
  componentId: Joi.string()
    .required()
    .messages({
      'any.required': 'Component ID is required'
 ...
 */
export const priceAlertUpdateSchema = Joi.object({
  targetPrice: Joi.number()
    .min(0.01)
    .max(10000)
    .optional(),
 ...
 */
export const priceBatchCaptureSchema = Joi.object({
  prices: Joi.array()
 ...
 */
export const dealBatchAssessSchema = Joi.object({
  deals: Joi.array()
